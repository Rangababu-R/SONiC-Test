...
from files.configs.pfc_wd import pfc_watch_dog_configs, one_hundred_gbe, serializer
from files.configs.pfc_wd import start_delay, traffic_duration, pause_line_rate,\
...
def test_pfc_watch_dog(api, 
    ...
    for config in pfc_watch_dog_configs:        
        api.set_config(None)
        ...
        ###############################################################################################
        # Start all flows 
        # 1. check for no loss in the flows Traffic 1->2,Traffic 2->3
        ...
        #Check for traffic observations for two timestamps in t_btwn_start_pause_stop_pause
        while True:
