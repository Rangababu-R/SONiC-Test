...
@pytest.fixture
def pfcwd_params(request):
    # import pdb;pdb.set_trace()
    params = {}
    params['t_stop_pause'] = request.config.getoption("--t_stop_pause")
    params['t_start_pause'] = request.config.getoption("--t_start_pause")
    params['t_stop_traffic'] = request.config.getoption("--t_stop_traffic")
    params['storm_detection_time'] = request.config.getoption("--storm_detection_time")
    params['storm_restoration_time'] = request.config.getoption("--storm_restoration_time")
    params['pause_line_rate'] = request.config.getoption("--pause_line_rate")
    params['traffic_line_rate'] = request.config.getoption("--traffic_line_rate")
    params['start_delay'] = request.config.getoption("--start_delay")
    params['frame_size'] = request.config.getoption("--frame_size")
...
@pytest.fixture
def pfc_watch_dog_multi_host_config(pfc_watch_dog_config,
                                    serializer,
                                    pfcwd_params) :
    
    def _pfc_watch_dog_multi_host_config(pi):
